 ...
 * can call `conjure` as a tool with clean arguments; what this is for is the
...
/** Match a table whose *keys* are the words, like the colour wheel. */
function pickKey(table, words) {
...
export function parse(text, { aliases = {} } = {}) {
  ...
  const colourKey = pickKey(HUES, words);
